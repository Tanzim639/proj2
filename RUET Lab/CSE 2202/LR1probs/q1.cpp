//Implement and compare Insertion Sort, Counting Sort, and Merge Sort based on various input size on randomly generated data. 
//The comparison metric should be the execution time of each sorting algorithm.
